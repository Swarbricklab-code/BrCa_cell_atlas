...
if [[ "${STEP01}" == "TRUE" ]]; then
  ...
  for celltype in ${CELLTYPES}; do
      ...
      ${MEMPERCORE} \
      ${TEMPCELLTYPEDIR}' \
      ${TEMPPWD}/04_reprocessing_script.R" \
      ${TEMPPWD}/analysis_01_${celltype}/02_reprocessing_log_${celltype}.txt \
      > ${TEMPPWD}/analysis_01_${celltype}/JOBID_02_reprocessing_${celltype}.txt
