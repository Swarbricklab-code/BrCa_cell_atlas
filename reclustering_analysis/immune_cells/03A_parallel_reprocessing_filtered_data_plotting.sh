...
if [[ "${STEP01}" == "TRUE" ]]; then
  ...
  for celltype in ${CELLTYPES}; do
        JOBNAME="JOBID_03_reprocessing_${celltype}"
        CORES="4"
        MEMPERCORE="10G"
      ...
      ${MEMPERCORE} \
      ${TEMPCELLTYPEDIR}' \
      ${TEMPPWD}/06_reprocessing_script.R" \
      ${TEMPPWD}/analysis_01_${celltype}/03_reprocessing_log_${celltype}.txt \
      > ${TEMPPWD}/analysis_01_${celltype}/JOBID_03_reprocessing_${celltype}.txt
