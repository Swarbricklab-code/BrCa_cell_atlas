...
if [[ "${STEP01}" == "TRUE" ]]; then
  ...
  for celltype in ${CELLTYPES}; do
        JOBNAME="JOBID_06_iCITE_${celltype}"
        CORES="4"
        MEMPERCORE="10G"
      ...
      ${MEMPERCORE} \
      ${TEMPCELLTYPEDIR}' \
      ${TEMPPWD}/12_reprocessing_script.R" \
      ${TEMPPWD}/analysis_01_${celltype}/06_reprocessing_log_${celltype}.txt \
      > ${TEMPPWD}/analysis_01_${celltype}/JOBID_06_reprocessing_${celltype}.txt
