...
if [[ "${STEP01}" == "TRUE" ]]; then
  ...
  for celltype in ${CELLTYPES}; do
        JOBNAME="JOBID_07_annotated_${celltype}"
        CORES="4"
        MEMPERCORE="10G"
      ...
      ${MEMPERCORE} \
      ${TEMPCELLTYPEDIR}' \
      ${TEMPPWD}/14_reprocessing_script.R" \
      ${TEMPPWD}/analysis_01_${celltype}/07_reprocessing_log_${celltype}.txt \
      > ${TEMPPWD}/analysis_01_${celltype}/JOBID_07_reprocessing_${celltype}.txt
