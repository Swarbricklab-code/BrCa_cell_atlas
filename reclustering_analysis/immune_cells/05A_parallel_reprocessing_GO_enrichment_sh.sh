...
if [[ "${STEP01}" == "TRUE" ]]; then
  ...
  for celltype in ${CELLTYPES}; do
      ...
      ${MEMPERCORE} \
      ${TEMPCELLTYPEDIR}' \
      ${TEMPPWD}/10_reprocessing_script.R" \
      ${TEMPPWD}/analysis_01_${celltype}/05_reprocessing_log_${celltype}.txt \
      > ${TEMPPWD}/analysis_01_${celltype}/JOBID_05_reprocessing_${celltype}.txt
